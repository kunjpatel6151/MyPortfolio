    ...
    <section id="contact" ref={ref} className="relative py-28 px-6 bg-[#1A1A1A] text-[#F1EAD6] film-grain reveal">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-14">
          <p className="font-ui text-[#E51B24] tracking-[0.4em] text-xs uppercase">— Western Union —</p>
          <h2 className="font-western text-5xl sm:text-6xl mt-3">The Telegraph Office</h2>
          <p className="font-body italic text-[#F1EAD6]/60 mt-3">Send word. The wire runs day and night.</p>
        </div>
          ...
          >
            ...
            {sent ? (
              ...
              <div className="space-y-4">
                <div>
                  <label className="font-ui text-xs tracking-widest">NAME</label>
                  <input required maxLength={100} className="w-full mt-1 bg-transparent border-b-2 border-[#1A1A1A]/50 focus:border-[#E51B24] outline-none py-2 font-body" />
                </div>
                <div>
                  <label className="font-ui text-xs tracking-widest">EMAIL</label>
                  <input required type="email" maxLength={255} className="w-full mt-1 bg-transparent border-b-2 border-[#1A1A1A]/50 focus:border-[#E51B24] outline-none py-2 font-body" />
                </div>
                <div>
                  <label className="font-ui text-xs tracking-widest">MESSAGE</label>
                  <textarea required maxLength={1000} rows={5} className="w-full mt-1 bg-transparent border-b-2 border-[#1A1A1A]/50 focus:border-[#E51B24] outline-none py-2 font-body resize-none" />
                </div>
                <button
                  type="submit"
                  className="mt-4 w-full relative group flex items-center justify-center gap-3 bg-[#E51B24] text-[#F1EAD6] py-4 font-subheading tracking-widest hover:bg-[#1A1A1A] transition-colors border-2 border-[#1A1A1A]"
                >
                ...
                <li key={label}>
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="font-ui text-xs tracking-widest text-[#F1EAD6]/60 mt-1">{handle}</p>
                    </div>
                  </a>
                </li>
              ))}
