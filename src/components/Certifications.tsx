...
export function Certifications() {
  ...
  return (
    <section id="certifications" ref={ref} className="relative py-28 px-6 bg-[#1A1A1A] text-[#F1EAD6] film-grain reveal">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <p className="font-ui text-[#E51B24] tracking-[0.4em] text-xs uppercase">
            — Official Records —
          </p>
          <h2 className="font-western text-5xl sm:text-6xl mt-3">Verified Documents</h2>
        ...
        <div className="grid md:grid-cols-3 gap-8 lg:gap-12">
          {certifications.map((cert, idx) => (
            <div key={idx} className="reveal-child paper p-6 sm:p-8 ornate-border relative flex flex-col items-center text-center text-[#1A1A1A]">
